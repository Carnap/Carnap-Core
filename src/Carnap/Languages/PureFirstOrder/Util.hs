...
type FirstOrderTransformable lex = 
    ...
    , PrismLink (lex (FixLang lex)) (Function (StandardVar Int) (FixLang lex))
    ...
    , PrismLink (lex (FixLang lex)) (Binders (GenericQuant Term Form Bool Int) (FixLang lex))
    , PrismTermEquality lex Int Bool
    , PrismLink (lex (FixLang lex)) (Predicate (TermEq Bool Int) (FixLang lex))
    , PrismBooleanConnLex lex Bool
    , PrismLink (lex (FixLang lex)) (Connective (BooleanConn Bool) (FixLang lex))
    , PrismBooleanConst lex Bool
    , PrismLink (lex (FixLang lex)) (Connective (BooleanConst Bool) (FixLang lex))
    , PrismPolyadicFunction lex Int Int
    , PrismLink (lex (FixLang lex)) (Function (IntFunc Int Int) (FixLang lex))
    , PrismIndexedConstant lex Int
    , PrismLink (lex (FixLang lex)) (Function (IntConst Int) (FixLang lex))
...
comparableMatricies :: FirstOrderTransformable lex => FixLang lex (Form Bool) -> FixLang lex (Form Bool) 
...
universalClosure :: ( PrismStandardVar lex Int
                    , PrismLink (lex (FixLang lex)) (Function (StandardVar Int) (FixLang lex))
                    , PrismSubstitutionalVariable lex, BoundVars lex
                    , PrismLink (lex (FixLang lex)) (SubstitutionalVariable (FixLang lex))
                    , FirstOrderLex (lex (FixLang lex)), CopulaSchema (FixLang lex), Schematizable (lex (FixLang lex))
                    , QuantLanguage (FixLang lex (Form Bool)) (FixLang lex (Term Int))
                    ) => FixLang lex (Form Bool)-> FixLang lex (Form Bool)
...
isPNF :: (PrismGenericQuant lex Term Form Bool Int
         , PrismLink (lex (FixLang lex)) (Binders (GenericQuant Term Form Bool Int) (FixLang lex))
         , PrismSubstitutionalVariable lex
         , PrismLink (lex (FixLang lex)) (SubstitutionalVariable (FixLang lex))
         , BoundVars lex
...
quantFree :: ( PrismGenericQuant lex Term Form Bool Int
             , PrismLink (lex (FixLang lex)) (Binders (GenericQuant Term Form Bool Int) (FixLang lex))
             , PrismSubstitutionalVariable lex
             , BoundVars lex
             , FirstOrderLex (lex (FixLang lex))) 
